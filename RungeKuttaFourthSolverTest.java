...
public class RungeKuttaFourthSolverTest {
    
    DifferentialSolver solver = new RungeKuttaFourthSolver();
    INumericalFunction<Double, Vector3> derivative = (t, w) -> new Vector3(1.0, 0, 0);
