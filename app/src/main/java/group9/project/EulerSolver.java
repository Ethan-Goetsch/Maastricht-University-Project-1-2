...
public class EulerSolver
{
    ...
    {
        Vector3 derivative = currentAcceleration.multiplyBy(PhysicsEngine.getSpedUpStepTime());
    ...
    {
        Vector3 derivative = currentVelocity.multiplyBy(PhysicsEngine.getSpedUpStepTime());
