...
{
    /**
    * Solves and returns the answer to a differential equation using the Ralston's Method
    *   
    ...
    */
    ...
    public Vector3 solveNumericalEquation(Vector3 initialValue, INumericalFunction<Double, Vector3> derivativeFunction, double h, double t)
    {
        ...
        Vector3 k2 = derivativeFunction.evaluate(t + 2 / 3.0 * h, initialValue.add(k1.multiplyBy(2 / 3.0))).multiplyBy(h);
